export const taobaoDetailForm = [
  { label: '商品ID', prop: 'numIid', type: 'search' },
  ...
  { label: '专属券ID', prop: 'appointCoupon', type: 'searchCoupon' },
  { label: '优惠券面值', prop: 'couponAmount', disable: true },
...
export const jingdongDetailForm = [
  ...
  { label: '优惠券id/链接', prop: 'link', type: 'searchCoupon' },
